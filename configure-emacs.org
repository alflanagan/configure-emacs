...
#+begin_src emacs-lisp
  (org-babel-load-file (expand-file-name "secret-data.org" user-emacs-directory))
#+end_src
...
#+begin_src emacs-lisp
  (org-babel-load-file (expand-file-name "better-emacs-defaults.org" user-emacs-directory))
#+end_src
